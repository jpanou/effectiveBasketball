    ...
    <div className="min-h-screen pt-28 pb-20 px-6">
      ...
      {lightbox && (
        ...
        >
          ...
          <button
            onClick={() => setLightbox(null)}
            className="fixed top-6 right-6 bg-[#F97316] hover:bg-[#EA6D0E] text-white px-4 py-2 rounded-xl text-sm flex items-center gap-2 cursor-pointer transition-colors"
          >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Γνωρίστε την ομάδα του προπονητή</p>
        </motion.div>
        ...
        {(settings.team_name || settings.division) && (
          ...
          >
            {settings.team_name && (
              <div className="bg-[#111] border border-[#222] rounded-2xl px-6 py-4 flex items-center gap-3">

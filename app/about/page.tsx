        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 text-sm leading-loose">
              <p>
                Ο coach Στρατάκος είναι πτυχιούχος – πιστοποιημένος προπονητής καλαθοσφαίρισης (Α&apos; κατηγορίας) των σχολών
                της Γενικής Γραμματείας Αθλητισμού, με συνεχή και αδιάλειπτη προπονητική επιμόρφωση στα δρώμενα της
                εξέλιξης του αθλήματος.
              </p>
              <p>
                Είναι ενεργό μέλος του Συνδέσμου Ελλήνων Προπονητών Καλαθοσφαίρισης από το 1995. Έχει διατελέσει
                προπονητής σε όλες τις αναπτυξιακές βαθμίδες αγοριών, κοριτσιών, υπεύθυνος ακαδημιών, καθώς επίσης
                πρώτος προπονητής σε συλλόγους ανδρών, γυναικών που συμμετείχαν σε εθνικές κατηγορίες, σε πανελλήνια
                &amp; τοπικά πρωταθλήματα.
              </p>
              <p>
                Τη συγκεκριμένη χρονική στιγμή απασχολείτε στον οργανισμό της Κ.Α.Π. στο τμήμα ανδρών (πρωτάθλημα
                National League 2) για 3η συνεχόμενη αγωνιστική περίοδο, και αποτελεί μέλος του προπονητικού staff με
                την ιδιότητα του assistant coach και του scouting video coordinator.
              </p>
              <p>
                ...
                συναισθημάτων, συγκινήσεων και δυνατών αναμνήσεων που μένουν χαραγμένα στην μνήμη όλων των
                εμπλεκόμενων σε αυτά.
              </p>
            </div>
